...
-- -----------------------------------------------------
-- Table `EnergySom`.`ItensVenda`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EnergySom`.`ItensVenda` (
  `Id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `EnergySom`.`ItensVendaML`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EnergySom`.`ItensVendaML` (
  `Id` INT NOT NULL AUTO_INCREMENT,
  `IdProduto` INT NOT NULL,
  `IdVenda` INT NOT NULL,
