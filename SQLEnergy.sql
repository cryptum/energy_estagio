...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EnergySom`.`DataDoDia` (
  `Id` INT NOT NULL AUTO_INCREMENT,
  `Mes` INT NULL,
  `Ano` INT NULL,
  PRIMARY KEY (`Id`))
...
-- -----------------------------------------------------
-- Table `EnergySom`.`Despesa`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EnergySom`.`Despesa` (
  `Id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `EnergySom`.`EntradadeProduto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EnergySom`.`EntradadeProduto` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `IdProduto` INT NOT NULL,
  `Data` DATE NULL,
  ...
  `Quantidade` INT NULL,
  PRIMARY KEY (`ID`),
  INDEX `fk_EntradadeProduto_Produto1_idx` (`IdProduto` ASC),
  CONSTRAINT `fk_EntradadeProduto_Produto1`
    FOREIGN KEY (`IdProduto`)
    REFERENCES `EnergySom`.`Produto` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
INSERT INTO `funcionario` (`Id`, `Nome`, `Cpf`, `Rg`, `Nascimento`, `Telefone`, `Celular1`, `Celular2`, `Login`, `Senha`, `Admin`) VALUES
(1, 'ROOT', NULL, NULL, NULL, NULL, NULL, NULL, 'login', '123', true),
(2, 'root', NULL, NULL, '2018-02-14', NULL, NULL, NULL, 'login', '123', true);

INSERT INTO `DataDoDia` (`Id`, `Mes`, `Ano`) VALUES
(1, 5, 2018);
